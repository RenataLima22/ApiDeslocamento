...
namespace AppDeslocamento.Data.Mapping
{
    public class DeslocamentoConfiguration : IEntityTypeConfiguration<Deslocamento>
    {
        public void Configure(EntityTypeBuilder<Deslocamento> builder)
        {
            ...
            builder.Property(p => p.QuilometragemInicial).IsRequired().HasColumnName("QuilometragemInicial").HasColumnType("decimal");

            builder.Property(p => p.Observacao).HasColumnName("Observacao").HasMaxLength(200);

            builder.Property(p => p.DataHoraFim).HasColumnName("DataHoraFim").HasColumnType("datetime");

            builder.Property(p => p.QuilometragemFinal).HasColumnName("QuilometragemFinal").HasColumnType("decimal");
        }
    }
}
